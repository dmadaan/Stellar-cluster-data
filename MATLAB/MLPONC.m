...
[x,fval,exitflag,output] = simulannealbnd(@(c)loglikeMLP(Mass1,c),x0,lb,ub)
...
el_mlp = 2*loglikeMLP(Mass1,par1)% -2lnL
...
el_chab = 2*(l1 + l2 - n*log( 0.5016));% this is -2lnL
...
el_kroupa = 2*(l1 + l2 +l3 -n*log(0.3392));
